import { TorkConfig, NetworkPolicyConfig, NetworkDecision, NetworkActivityLog } from '../config';
...
function resolvePolicy(config: TorkConfig): Required<NetworkPolicyConfig> {
...
export class NetworkAccessHandler {
  private policy: Required<NetworkPolicyConfig>;
